...
for (a = 0; a < availablejobs.length; a++) {
    ...
    jobsslide.append(jobsicon, jobsposition, jobslocation, jobssalary, jobstext, btnview);

    document.getElementById("jobs-icon" + a).setAttribute("class", availablejobs[a].faicontype + " " + availablejobs[a].faicon);
    document.getElementById("jobs-position" + a).innerHTML = availablejobs[a].position;
    document.getElementById("jobs-location" + a).innerHTML = availablejobs[a].location;
    document.getElementById("jobs-salary" + a).innerHTML = availablejobs[a].salarymin + " - " + availablejobs[a].salarymax;
    document.getElementById("jobs-details-text" + a).innerHTML = availablejobs[a].details;
}
...
function openviewdetails(detersibling) {
    ...
    for (x = 0; x < availablejobs.length; x++) {
        ...
        if (determineid == textid) {
            document.getElementById("jobs-details-pos").innerHTML = availablejobs[x].position;
            document.getElementById("jobs-details-loc").innerHTML = availablejobs[x].location;
            document.getElementById("jobs-details-sal").innerHTML = availablejobs[x].salarymin + " - " + availablejobs[x].salarymax;
            document.getElementById("jobs-details-text").innerHTML = availablejobs[x].details;
